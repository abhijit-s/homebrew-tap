class Fff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/abhijit-s/fff/releases/download/v0.17.1/fff-aarch64-apple-darwin.tar.gz"
      sha256 "cedc471350cd187e253f508f67e79878b65c1ba6aea46c4b73dc8a02ba191913"
    end
  end
