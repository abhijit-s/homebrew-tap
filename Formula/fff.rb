class Fff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/abhijit-s/fff/releases/download/v0.18.0/fff-aarch64-apple-darwin.tar.gz"
      sha256 "505c9c5ac9c64fcce9621887a92df5f3ce8f390afa7046987e11a28d87ff6ce1"
    end
  end
