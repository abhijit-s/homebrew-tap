class Fff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/abhijit-s/fff/releases/download/v0.19.3/fff-aarch64-apple-darwin.tar.gz"
      sha256 "dacb7ee9796c0e8cabf58b2f2e1b11bc273a4b86eb646a04e6289149a8384e15"
    end
  end
