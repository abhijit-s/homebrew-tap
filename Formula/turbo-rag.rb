class TurboRag < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/abhijit-s/homebrew-tap/releases/download/turbo-rag-v0.21.0/turbo-rag-0.21.0-wheelhouse-macos-arm64.tar.gz"
      sha256 "a6104ab3025a48434659ada8ba0ae5f20b9505f814b2b3769631fa8d2ef3965c"
    end
  end
